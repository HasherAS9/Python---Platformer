...
# define font
font1 = pygame.font.SysFont('Jokermanr', 90)
font = pygame.font.SysFont('Chiller', 90)
font_score = pygame.font.SysFont('Algerian', 45)
    ...
    if main_menu == True:
        ...
        if game_over == 0:
            ...
            if pygame.sprite.spritecollide(player, coin_group, True):
                score += 1
                coin_fx.play()
            draw_text('SCORE = ' + str(score), font_score, blue, tile_size - 10, 10)
        ...
        if game_over == 1:
            ...
            if level <= max_levels:
                ...
                draw_text('YOU WIN!', font, blue1, (screen_width // 2) - 140, screen_height // 2)
                if restart_button.draw():
                    level = 1
                    # reset level
                    world_data = []
